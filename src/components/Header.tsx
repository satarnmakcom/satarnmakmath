      ...
      <div className="flex items-center gap-2 md:gap-3 ml-3">
        ...
        >
          <motion.svg 
            ...
            className="w-5 h-5 hidden dark:block" fill="none" stroke="currentColor" viewBox="0 0 24 24"
          >
          ...
          <motion.svg 
            ...
            animate={{ rotate: 0 }}
            whileHover={{ rotate: -90 }}
            className="w-5 h-5 block dark:hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24"
          >
        ...
        <motion.button 
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          className="relative p-2.5 rounded-xl hover:bg-[var(--bg-secondary)] text-[var(--text-secondary)] transition-colors"
        >
          <motion.svg 
        ...
        <Link href="/profile" className="block ml-1">
          ...
          >
            <motion.img 
              whileHover={{ rotate: 5 }}
              src="https://api.dicebear.com/7.x/avataaars/svg?seed=AlexChen" alt="Alex" 
