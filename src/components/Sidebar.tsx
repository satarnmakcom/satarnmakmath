    ...
    >
      ...
      <div className="p-3 border-t border-[var(--border-color)] flex-shrink-0">
        <motion.button 
          ...
          whileTap={{ scale: 0.95 }}
          className={`w-full flex items-center ${collapsed ? 'justify-center' : 'gap-3'} px-3 py-2.5 rounded-xl text-sm font-medium text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors`}
        >
