    ...
    <div className="max-w-6xl mx-auto py-8">
      ...
      <div className="relative mb-12 p-8 md:p-12 rounded-[2.5rem] overflow-hidden border border-[var(--border-color)] bg-[var(--glass-bg)] backdrop-blur-2xl shadow-2xl shadow-black/5">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-[var(--text-primary)] tracking-tight mb-4">Contests & <span className="text-transparent bg-clip-text bg-gradient-to-r from-electric-400 to-violet-400">Mock Exams</span></h1>
          <p className="text-[var(--text-secondary)] text-lg max-w-2xl">
            Test your skills under timed conditions. Your solutions will be automatically graded by AI, simulating real Olympiad environments.
          </p>
        </div>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          >
            ...
            <div className="relative h-full flex flex-col bg-[var(--glass-bg)] backdrop-blur-xl rounded-[23px] p-6">
              ...
              {set.description ? (
                ...
                <p className="text-sm text-[var(--text-tertiary)] italic mb-6 flex-grow">No description provided.</p>
              )}
        ...
        {sets.length === 0 && (
          <div className="col-span-full flex flex-col items-center justify-center py-24 bg-[var(--bg-card)] rounded-3xl border border-dashed border-[var(--border-color)]">
            ...
            <h3 className="text-2xl font-bold text-[var(--text-primary)] mb-2">No Active Contests</h3>
            <p className="text-[var(--text-secondary)] text-center max-w-md">
              There are currently no mock exams available. Check back later or ask your instructor for upcoming contests.
            </p>
          </div>
        )}
      </div>
